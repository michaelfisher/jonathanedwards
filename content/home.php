...
<div id="home" class="col-xs-12">
	...
	<div id="home-content">
		...
		<div id="home-buttons" class="container">
			<ul>
				<li class="col-sm-6 col-xs-12"><a id="order-now-button" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=LGGQYR9UAFTYQ" class="btn btn-block btn-lg btn-default"><span class="glyphicon glyphicon-shopping-cart"></span> Order Now</a></li>
