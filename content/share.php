...
<div id="share" class="col-xs-12">
	...
	<div id="share-header" class="col-xs-12">
		<h1>Share</h1>
	</div>
	...
	<div id="share-buttons" class="container">
		<ul>
			...
			<li class="col-sm-4 col-xs-12"><a id="twitter-share-button" class="btn btn-block btn-lg btn-default" target="_blank" href="http://twitter.com/intent/tweet?url=http://left-book.com&text=Looking+forward+to+reading+LEFT%3A+The+Struggle+to+Make+Sense+of+Life+When+a+Parent+Leaves+by+%40notthepuritan%21+9.16.14&amp;source=webclient">Twitter</a></li>
